const slider = () => {
  function bindSlider(sliderSelector, slidesSelector, prevSelector, nextSelector) {
  ...
  bindSlider(".banner-slides", ".banner-slide", ".banner-slider-prev-btn", ".banner-slider-next-btn");
};
